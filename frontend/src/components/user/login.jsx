      ...
      <div className="w-full max-w-md bg-black/40 backdrop-blur-2xl border border-white/10 rounded-[32px] p-8 md:p-12 shadow-2xl relative z-10 animate-in fade-in slide-in-from-bottom-8 my-auto">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white/5 hover:bg-white/10 border border-white/10 text-white font-bold py-4 rounded-2xl transition-all duration-300 hover:border-white/20 disabled:opacity-50 group"
          >
